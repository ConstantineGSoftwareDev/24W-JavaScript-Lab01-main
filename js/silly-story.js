...
function result() {
    ...
    console.log(customName.textContent);
    ...
    if (document.getElementById("metric").checked) {
        ...
        let metricWeight = 300*0.453592;
        console.log(metricWeight.toPrecision(5));
        // STEP 11b: Replace the string 300 pounds with the updated weight in kg
        var metricStringWeight = String(metricWeight.toPrecision(5)) + " kilograms";

        newStory = newStory.replace("300 pounds", metricStringWeight);
        // STEP 12a: Create a variable called temp and convert °F to °C ... the formula for conversion is °C = (°F - 32) x 5/9
        
        let tempInC = (94-32)* 5/9;
        var metricStringTemp = String(tempInC.toPrecision(4)) + " celsius";

        console.log(metricStringTemp);
        // STEP 12b: Replace the string '94 fahrenheit' with the updated temperature in °C
        newStory = newStory.replace("94 farenheit", metricStringTemp);
        console.log(newStory);
